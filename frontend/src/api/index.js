export default {
  COMMUNICATION_TEST: '/api/test',
  GET_EPIDEMIC_DATA: '/api/retrieve/epidemic',
  ...
  GET_ARTICLES: '/api/retrieve/articles',
  GET_ARTICLES_WITHIN_TIME: '/api/retrieve/articles/timeRange/:timeMin/:timeMax',
